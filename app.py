...
# 5. Unified Logic Chain (The Controller)
...
if choice == "Data Sanitizer":
    ...
    if st.session_state['data'] is not None:
        ...
        if query:
            ...
            st.write("Co-Pilot logic: Based on your current dataset, focus on reducing operational friction in your primary growth drivers.")
            st.caption("✨ Strategic Pro-Tip: Your data efficiency is currently 84%.")
    else:
